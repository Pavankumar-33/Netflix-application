...
public abstract class JPADAO<T> {
    ...
    public abstract Query<T> getbyUsername(String username, String password, Session session);
    ...
    public List<T> searchbyUsername(String username, String password){
        Session session = getSession();
        Query<T> query = getbyUsername(username, password,session);
        return query.list();
    }
